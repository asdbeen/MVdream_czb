...
def train(args):
    ...
    # Validation function
    def validate(val_loader, model, sampler, image_encoder, cond_proj, ref_pose_proj, device, fp16, save_images=False, save_dir=None):
        ...
        with torch.no_grad():
            for batch in val_loader:
                ...
                with torch.autocast(device_type='cuda', dtype=torch.float16, enabled=fp16):
                    ...
                    c = torch.cat([c_text, hull_rep, pose_rep], dim=1)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if val_dl is not None:
            ...
            val_loss = validate(val_dl, model, sampler, image_encoder, cond_proj, ref_pose_proj, device, args.fp16, 
